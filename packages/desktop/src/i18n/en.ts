...
export const en = {
  ...
  'operators.capsAgents': '{count} agent(s) in its local config',
  ...
  'operators.registerHere': 'Register this machine',
  'operators.registerHereNote': 'This machine runs an operator. One click mints a code and hands it to that operator, which registers itself and connects right away.',
  'operators.registerHereDone': 'Registered: {name}. Assign agents to it under Agents › the agent › Where it runs.',
  'operators.registerHereFailed': 'This machine was not registered: {reason}',
  'operators.registerElsewhereNote': 'To register a different machine, mint a code here and run the command there within five minutes.',
  ...
  'agents.scope.invoke.channel': 'Members of the channel it is called in',
  'agents.scope.invoke.list': 'Only the people listed below',
  'agents.scope.invoke.owner': 'Only the owner',
  'agents.scope.credential': 'Credentials it runs with',
  'agents.scope.credential.none': 'No credentials',
  'agents.scope.credential.community': 'Shared community credentials',
  'agents.scope.credential.personal': 'The owner\u2019s personal credentials',
  'agents.scope.invokers': 'Allowed callers',
  'agents.scope.invokersNone': 'Nobody yet — only the owner can call it until someone is added.',
  'agents.scope.addInvoker': 'Add',
  'agents.scope.pickPerson': 'Choose a person…',
  'agents.scope.removeInvoker': 'Remove @{handle}',
  ...
  'mcpServers.kind.community': 'shared credentials',
  'mcpServers.kind.personal': 'personal credentials',
  'mcpServers.kindLabel': 'Credential kind',
  'mcpServers.name': 'Name',
  'mcpServers.add': 'Add',
  'mcpServers.addTitle': 'Register a name',
  ...
  'agents.local.loading': 'Reading the local operator config…',
  'agents.local.listFailed': 'The local operator config could not be read',
  'agents.local.unregistered': 'The operator on this machine is not registered with this community yet — run `harkroom-operator register` first. The entry below is kept and becomes a capability once registered.',
  'agents.local.enable': 'Let the operator on this machine run this agent',
  'agents.local.workingDir': 'Working directory on this machine',
  'agents.local.workingDirPlaceholder': '~/dev/project (empty = the agent default)',
  'agents.local.save': 'Save',
  'agents.local.saved': 'Saved',
  'agents.local.added': 'Added to this machine\u2019s operator',
  'agents.local.removed': 'Removed from this machine\u2019s operator',
  'agents.local.failed': 'Not saved: {reason}',
  'agents.local.note': 'An operator only runs agents listed in its own config. Assigning above is the other half.',
