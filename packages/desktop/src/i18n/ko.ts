...
export const ko = {
  ...
  'agents.create.runHere': '이 기기에서 돌린다',
  'agents.create.runHereNote': '만들면서 이 기기의 오퍼레이터에 배정한다 — 그래야 곧바로 뜬다. 다른 기기에서 돌릴 것이면 꺼라.',
  'agents.create.attachFailed': '에이전트는 만들어졌지만 이 기기에 배정하지 못했다: {reason}. 상세 화면에서 배정해라.',
  ...
  'agents.memory.collapse': '{slug} 접기',
  'agents.memory.coreNote': '이 글자 수만큼 매 턴 프롬프트에 실린다. 나머지 기억은 에이전트가 필요할 때만 연다.',
  'agents.memory.coreTag': '매 턴 실림',
  ...
  'agents.memory.expand': '{slug} 펼치기',
  'agents.memory.failed': '기억을 불러오지 못했다',
  'agents.memory.groupCollapse': '{key} 묶음 접기',
  'agents.memory.groupCount': '{n}개',
  'agents.memory.groupExpand': '{key} 묶음 펼치기',
  ...
  'agents.memory.limitNote': '한도에 가깝다 — 차면 새 기억이 거절된다',
  'agents.memory.loading': '불러오는 중…',
  'agents.memory.noMatch': '찾는 기억이 없다',
  'agents.memory.search': 'slug·본문에서 찾기',
  'agents.memory.sortLabel': '정렬',
  ...
  'terminal.diagnostics': '렌더러 {renderer} · 조합 {compositions} · IME키 {imeKeys} · 한글키 {hangulKeys}',
  ...
  'operators.capsAgents': '로컬 설정의 에이전트 {count}개',
  'operators.harnessReady': '설치·로그인됨',
  'operators.harnessNotLoggedIn': '설치됨, 로그인 안 됨',
  'operators.harnessMissing': '없음',
  'operators.revoke': '폐기',
  ...
  'operators.registerHere': '이 머신을 등록',
  'operators.registerHereNote': '이 머신에는 오퍼레이터가 돈다. 한 번 누르면 코드를 발급해 그 오퍼레이터에 넘기고, 오퍼레이터가 스스로 등록해 곧바로 붙는다.',
  'operators.registerHereDone': '등록됐다: {name}. 에이전트 › 상세 › 어디서 돌리나 에서 배정하라.',
  'operators.registerHereFailed': '이 머신을 등록하지 못했다: {reason}',
  'operators.registerElsewhereNote': '다른 머신을 등록하려면 여기서 코드를 발급해 5분 안에 그 머신에서 명령을 실행하라.',
  ...
  'agents.scope.invoke.channel': '부르는 채널의 멤버',
  'agents.scope.invoke.list': '아래 명단의 사람만',
  'agents.scope.invoke.owner': '소유자만',
  'agents.scope.credential': '쥐고 도는 자격증명',
  'agents.scope.credential.none': '자격증명 없음',
  'agents.scope.credential.community': '커뮤니티 공용 자격증명',
  'agents.scope.credential.personal': '소유자의 개인 자격증명',
  'agents.scope.invokers': '부를 수 있는 사람',
  'agents.scope.invokersNone': '아직 없다 — 누군가를 넣기 전까지는 소유자만 부른다.',
  'agents.scope.addInvoker': '넣기',
  'agents.scope.pickPerson': '사람을 고른다…',
  'agents.scope.removeInvoker': '@{handle} 빼기',
  'agents.scope.mcp': 'MCP 서버',
  'agents.scope.mcpLoading': '레지스트리를 읽는 중…',
  'agents.scope.mcpListFailed': 'MCP 레지스트리를 읽지 못했다',
  'agents.scope.mcpNone': '레지스트리가 비었다 — 설정 › MCP servers 에서 admin 이 이름을 넣는다.',
  ...
  'mcpServers.kind.community': '공용 자격증명',
  'mcpServers.kind.personal': '개인 자격증명',
  'mcpServers.kindLabel': '자격증명 종류',
  'mcpServers.name': '이름',
  'mcpServers.add': '넣기',
  'mcpServers.addTitle': '이름 등록',
  'mcpServers.addNote': '그 다음 이 이름을 쓰는 에이전트를 돌릴 오퍼레이터 머신마다 정의를 적는다: <데이터 디렉터리>/operator/mcp-servers.json 또는 ~/.claude.json.',
  'mcpServers.badName': '이름은 [a-z0-9-] 1~32자다',
  'mcpServers.saveFailed': '저장하지 못했다: {reason}',
  'mcpServers.remove': '빼기',
  'mcpServers.removeAction': '{name} 빼기',
  'mcpServers.deleteFailed': '빼지 못했다: {reason}',
  'agents.local.heading': '이 머신',
  'agents.local.loading': '오퍼레이터 로컬 설정을 읽는 중…',
  'agents.local.listFailed': '오퍼레이터 로컬 설정을 읽지 못했다',
  'agents.local.unregistered': '이 머신의 오퍼레이터가 아직 이 커뮤니티에 등록되지 않았다 — 먼저 `harkroom-operator register` 를 돌려라. 아래 항목은 남아 있다가 등록되면 능력이 된다.',
  'agents.local.enable': '이 머신의 오퍼레이터가 이 에이전트를 돌릴 수 있게',
  'agents.local.workingDir': '이 머신에서의 작업 디렉터리',
  'agents.local.workingDirPlaceholder': '~/dev/project (비우면 에이전트 기본값)',
  'agents.local.save': '저장',
  'agents.local.saved': '저장했다',
  'agents.local.added': '이 머신의 오퍼레이터에 넣었다',
  'agents.local.removed': '이 머신의 오퍼레이터에서 뺐다',
  'agents.local.failed': '저장하지 못했다: {reason}',
  'agents.local.note': '오퍼레이터는 자기 설정에 있는 에이전트만 돌린다. 위의 배정이 나머지 절반이다.',
